...
cfg["kl_threshold"] = 0
cfg["rewards_shaper"] = lambda rewards, timestep, timesteps: rewards * 0.2
...
cfg["experiment"]["directory"] = "isaacgymenvs/runs/Quadcopter"
...
# path = "isaacgymenvs/runs/Quadcopter/24-02-20_02-02-46-613793_PPO/checkpoints/agent_500000.pt"
# agent.load(path)
# trainer.eval()
