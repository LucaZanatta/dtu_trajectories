...
def save_to_csv(x, y, z, filename='isaacgymenvs/tasks/trajectory/swirl.csv'):
...
def plot_3d_trajectory(x, y, z):
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    ax.set_title('swirl', fontsize=16)
    ax.legend()
    plt.savefig('isaacgymenvs/tasks/trajectory/figure/swirl.png', dpi=600)
    plt.show()
