...
# velocity_log = pd.read_csv('velocity_log.csv')
...
body_drone_linvels_log = pd.read_csv('body_drone_linvels_log.csv')
...
# # Read the data from body_drone_linvels_log.csv
# forces_log = pd.read_csv('forces_log.csv')
...
# # friction_log
# friction_log = pd.read_csv('friction_log.csv')
...
# # root_linvels_log
# root_linvels_log = pd.read_csv('root_linvels_log.csv')
