...
def generate_line_xyz_points(num_points):
...
def save_to_csv(x, y, z, filename='line_xyz.csv'):
...
def plot_3d_trajectory(x, y, z):
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    ax.set_title('line xyz', fontsize=16)
    ax.legend()
    plt.savefig('isaacgymenvs/tasks/trajectory/figure/line_xyz.png', dpi=600)
    plt.show()


num_points = 20
x, y, z = generate_line_xyz_points(num_points)
