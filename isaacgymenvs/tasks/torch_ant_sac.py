...
env = load_isaacgym_env_preview4(task_name="Crazyflie", num_envs=40)
env = wrap_env(env)
...
memory = RandomMemory(memory_size=1000000, num_envs=env.num_envs, device=device)
...
cfg["experiment"]["directory"] = "isaacgymenvs/runs/crazyflie_sac"
cfg["experiment"]["experiment_name"] = "crazyflie_sac"
